class Vehicle(object):
    ...
    def __init__(self,year,mileage,purchase_price,serial_number):
        ...
        Vehicle.vehicle_id =
        if type(year) != int:
            raise ValueError("The argument 'year' must be of type int.")
        elif type(mileage) != int:
            raise ValueError("The argument 'mileage' must be of type int.")
        elif type(purchase_price) != int:
            raise ValueError("The argument 'purchase_price' must be of type int.")
