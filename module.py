...
class Course(Module):
    def __str__(self):
        return "Course: %s" % self.get_title()
...
class Seminar(Module):
    ...
    def __str__(self):
        return "%s under the topic: %s" % (self.get_title(), self.get_topic())
...
class Thesis(Module):
    ...
    def __str__(self):
        return "%s on the topic: %s in the Research Group %s" %(self.get_title(), self.get_topic(), self.get_research_group())
